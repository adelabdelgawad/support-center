...
import { useNavMobile } from "@/hooks/use-nav-mobile"
...
function Sidebar({
  ...
  // On mobile, return null - MobileNavDrawer handles the mobile drawer separately
  // This allows for custom mobile navigation with section grouping
  if (isMobile) {
    return null
  }
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-background relative flex w-full flex-1 flex-col min-h-0 overflow-x-hidden",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // Increases the hit area of the button on mobile (< lg breakpoint).
...
function SidebarMenuSkeleton({
  ...
  // Random width between 50 to 90% (lazy initialization ensures value is computed only once)

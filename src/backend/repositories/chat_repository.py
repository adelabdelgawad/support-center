...
from models import ChatMessage, RequestStatus, ServiceRequest, User
...
class ChatMessageRepository(BaseRepository[ChatMessage]):
    ...
    async def get_read_unread_counts_for_requester(
        ...
        read_count_query = (
            ...
            .where(and_(ChatMessage.is_read == True, *base_conditions))
        )
        ...
        unread_count_query = (
            ...
            .select_from(ChatMessage)
            .join(ServiceRequest, ChatMessage.request_id == ServiceRequest.id)
            .where(and_(ChatMessage.is_read == False, *base_conditions))
        )

"""
Organizational Unit Repository for database operations.
"""
...
class OrganizationalUnitRepository(BaseRepository[OrganizationalUnit]):
    """Repository for OrganizationalUnit database operations."""
    ...
    async def get_all(
        ...
        if enabled_only:
            stmt = stmt.where(OrganizationalUnit.is_enabled == True)

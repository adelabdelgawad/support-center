"""drop deployment control plane tables (devices, deployment_jobs, credentials)

Revision ID: b89ec16e2cad
...
def downgrade() -> None:
    ...
    op.create_index('ix_devices_discovery_source', 'devices', ['discovery_source'])
    op.create_index('ix_devices_created_at', 'devices', ['created_at'])
    op.create_index('ix_devices_desktop_session_id', 'devices', ['desktop_session_id'])
    op.create_index('ix_devices_state_source', 'devices', ['lifecycle_state', 'discovery_source'])
    ...
    op.create_index('ix_deployment_jobs_status_created', 'deployment_jobs', ['status', 'created_at'])
    ...
    op.create_index('ix_credentials_enabled', 'credentials', ['enabled'])

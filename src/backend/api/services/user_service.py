...
- Migrated database operations to UserCRUD (repository pattern)
"""
...
from api.schemas.user import UserCreate, UserListItem, UserUpdate
...
class UserService:
    ...
    async def get_user(db: AsyncSession, user_id: int) -> Optional[User]:
        ...
        Returns:
            User or None
        """
        return await UserCRUD.find_by_id(db, user_id)
    ...
    async def get_user_by_username(
        ...
        Returns:
            User or None
        """
        return await UserCRUD.find_by_username(db, username)
    ...
    async def get_user_by_email(
        ...
        Returns:
            User or None
        """
        return await UserCRUD.find_by_email(db, email)
    ...
    async def list_users(
        ...
        users, total = await UserCRUD.list_users_paginated(
            db,
    ...
    async def update_online_status(
        ...
        user = await UserCRUD.update_online_status(
    ...
    async def delete_user(db: AsyncSession, user_id: int) -> bool:
        ...
        """
        return await UserCRUD.soft_delete(db, user_id, commit=True)
    ...
    async def get_online_technicians(db: AsyncSession) -> List[UserListItem]:
        ...
        """
        users = await UserCRUD.get_online_technicians(db)

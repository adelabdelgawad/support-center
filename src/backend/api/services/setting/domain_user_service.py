...
from api.repositories.setting.domain_user_repository import DomainUserRepository
...
class DomainUserService:
    ...
    async def sync_from_ad(db: AsyncSession) -> DomainUserSyncResponse:
        ...
        try:
            ...
            deleted_count = await DomainUserRepository.delete_all(db)
            ...
            # Step 4: Bulk insert
            created_count = await DomainUserRepository.bulk_create(
    ...
    async def get_paginated_users(
        ...
        *,
        ...
        """
        users, total = await DomainUserRepository.search_users(
